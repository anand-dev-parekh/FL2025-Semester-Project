        ...
        <div className="flex flex-wrap items-center gap-6">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="rounded-full border border-slate-300 bg-transparent px-4 py-2 text-sm font-medium text-slate-800 transition hover:border-rose-300 hover:bg-rose-50 hover:text-rose-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-rose-200 dark:border-slate-600 dark:text-slate-100 dark:hover:border-rose-400 dark:hover:bg-rose-900/40 dark:hover:text-rose-200"
            >
              Sign Out
            </button>
            <ThemeToggle />
